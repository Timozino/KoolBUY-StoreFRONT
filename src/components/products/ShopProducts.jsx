    ...
    return (
        ...
        <div className={styles === 'grid' ? 'w-full relative group h-[210px] md:h-[270px] xs:h-[170px] overflow-hidden' : 'md-lg:w-full relative group h-[210px] md:h-[270px] overflow-hidden'}>
          ...
          <ul className='flex transition-all duration-700 -bottom-10 justify-center items-center gap-2 absolute w-full group-hover:bottom-3'>
            <li className='w-[38px] h-[38px] cursor-pointer bg-orange-300 flex justify-center items-center rounded-full hover:bg-[#ff5821] hover:text-white hover:rotate-[720deg] transition-all'>
            <FaRegHeart />
            </li>
            <li className='w-[38px] h-[38px] cursor-pointer bg-orange-300 flex justify-center items-center rounded-full hover:bg-[#ff5821] hover:text-white hover:rotate-[720deg] transition-all'>
            <FaEye />
