        ...
        <tbody>
            {
                ...
                <td scope='row' className='px-6 py-4 font-medium whitespace-nowrap'>
                    ...
                    {
                       o.payment_status !== 'paid' && <span onClick={() => redirect(o)} className='bg-green-200 text-black text-md font-semibold mr-2 px-3 py-[2px] rounded cursor-pointer'>Pay Now</span> 
                    }
