   ...
   const buynow = () => {
        ...
        const obj = [
            {
                ...
                shopName: "KoolBUY",//product.shopName,
        ...
        navigate('/shipping',{
            state: {
                ...
                shipping_fee : Math.ceil(price * (5/100)),
                items: 1
            }
        }) 
   }
    ...
    <section>
        ...
        <div className='flex flex-col gap-5'>
         ...
         <div className='text-2xl text-red-500 font-bold flex gap-3'>
          ...
          <div className='text-slate-600'>
            ...
            <p className='text-slate-600 py-1 font-bold'>KoolBUY</p>
           </div> 
        ...
        <div className='flex bg-slate-200 h-[50px] justify-center items-center text-xl'>
            ...
            <div onClick={inc} className='px-6 cursor-pointer'>+</div>
                    ...
                    <div>
                        <button onClick={add_card} className='px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-green-500/40 bg-[#000000] text-white'>Add To Cart</button>
                    </div>
                ...
                <div>
                    <div onClick={add_wishlist} className='h-[50px] w-[50px] flex justify-center items-center cursor-pointer hover:shadow-lg hover:shadow-orange-500/40 bg-black text-white'>
                    <FaHeart />
                    </div> 
                </div> 
            </div>  
    ...
    <ul className='flex justify-start items-center gap-3'>
        <li>
            <a className='w-[38px] h-[38px] hover:bg-blue hover:text-white flex justify-center items-center bg-indigo-500 rounded-full text-white' href="#"> <FaFacebookF /> </a>
        </li>
        <li>
        ...
        <li>
          ...
          <div className='flex gap-3'>
                {
                    product.stock ? <button onClick={buynow} className='px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-green-500/40 bg-[#000000] text-white'>Buy Now</button> : ''
                }
...
<div className='pl-4 md-lg:pl-0'>
    <div className='px-3 py-2 text-slate-600 bg-slate-200'>
        ...
        <h2 className='font-bold'>From KoolBUY</h2>
    </div>
