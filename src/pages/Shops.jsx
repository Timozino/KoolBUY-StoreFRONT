    ...
    return (
        <div>
           ...
           <section className='py-16'>
            ...
            <div className={` md:block hidden ${!filter ? 'mb-6' : 'mb-0'} `}>
                <button onClick={() => setFilter(!filter)} className='text-center w-full py-2 px-3 bg-[#ff5821] text-black'>Filter Product</button> 
            </div>
            ...
            <div className='w-full flex flex-wrap'>
                <div className={`w-3/12 md-lg:w-4/12 md:w-full pr-8 ${filter ? 'md:h-0 md:overflow-hidden md:mb-6' : 'md:h-auto md:overflow-auto md:mb-0' } `}>
                    <h2 className='text-3xl font-bold mb-3 text-[#000000]'>Category </h2>
        <div className='py-2'>
            {
        ...
        <div className='py-2 flex flex-col gap-5'>
            <h2 className='text-3xl font-bold mb-3 text-black'>Price</h2>
             ...
             <Range
                ...
                renderTrack={({props,children}) => (
                    <div {...props} className='w-full h-[6px] bg-orange-100 rounded-full cursor-pointer'>
                        {children}
                    </div>
                )}
                renderThumb={({ props }) => (
         ...
         <div className='py-3 flex flex-col gap-4'>
            <h2 className='text-3xl font-bold mb-3 text-black'>Rating </h2>
